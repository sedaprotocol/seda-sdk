...
export declare const MsgStoreDataRequestWasmResponse: {
    encode(message: MsgStoreDataRequestWasmResponse, writer?: _m0.Writer): _m0.Writer;
...
export declare const MsgInstantiateAndRegisterProxyContract: {
    encode(message: MsgInstantiateAndRegisterProxyContract, writer?: _m0.Writer): _m0.Writer;
...
export declare const MsgInstantiateAndRegisterProxyContractResponse: {
    encode(message: MsgInstantiateAndRegisterProxyContractResponse, writer?: _m0.Writer): _m0.Writer;
    ...
    create(base?: DeepPartial<MsgInstantiateAndRegisterProxyContractResponse>): MsgInstantiateAndRegisterProxyContractResponse;
    fromPartial(object: DeepPartial<MsgInstantiateAndRegisterProxyContractResponse>): MsgInstantiateAndRegisterProxyContractResponse;
};
...
export interface Msg {
     ...
     */
    InstantiateAndRegisterProxyContract(request: MsgInstantiateAndRegisterProxyContract): Promise<MsgInstantiateAndRegisterProxyContractResponse>;
