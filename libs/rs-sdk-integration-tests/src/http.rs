...
/**
 * Specify 1000ms timeout for an endpoint that responds in 5000ms.
 */
pub fn test_user_http_timeout() {
    let mut headers = BTreeMap::new();
    headers.insert("Content-Type".to_string(), "application/json".to_string());
...
/**
 * Specify 5000ms timeout for an endpoint that responds in 1000ms.
 */
...
/**
 * Specify 20000ms timeout for an endpoint that takes 10000ms to respond.
 */
